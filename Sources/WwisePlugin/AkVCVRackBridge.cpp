...
// CAkDelayApp
BEGIN_MESSAGE_MAP(CAkVCVRackBridgeApp, CWinApp)
END_MESSAGE_MAP()


// CAkDelayApp construction

CAkVCVRackBridgeApp::CAkVCVRackBridgeApp()
{

}

// The one and only CAkDelayApp object
CAkVCVRackBridgeApp theApp;

// CAkDelayApp initialization
BOOL CAkVCVRackBridgeApp::InitInstance()
{
...
{
	return new VCVRackBridgePlugin;
}
